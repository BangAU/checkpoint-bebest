            ...
            <div class="intro-text">
                <div class="container">
                    <div class="intro-text-wrap"> 
                        ...
                        <a href="" class="btn">Start your Engines</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="img-text" id="lets-talk">
        <div class="container">
            <div class="img-text-wrap">
                ...
                <div class="img-holder img-right">
...
With Check Point in your side-car, you can safely handle the sharpest turns and keep your eyes on the prize.</p>
    ...
    <section class="ready" id="ready">
        <div class="container">
            <img src="images/img-3.png"class="bg-img"/>
            <div class="inner-container">
        ...
        <div class="container">
            <div class="form-wrap">
                <div class="form-heading">
                    ...
                    <h3>Purchase or Upgrade with Check point today</h3>
                </div>
